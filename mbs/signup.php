...
<body bgcolor="red" >
<?php
$connection = mysqli_connect('localhost', 'root', '','mbs');
if (!$connection){
    die("Database Connection Failed" . mysqli_error($connection));
}
$select_db = mysqli_select_db($connection, 'mbs');
if (!$select_db){
 ...
 if (isset($_POST['username']) && isset($_POST['password'])){
  ...
  <div class="body"></div>
		...
		<form class ="login" method="POST" action="signup.php" >
				...
				<input type="password" placeholder="Confirm Password" name="pass2"><br><br>
